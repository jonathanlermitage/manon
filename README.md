...
* **[Pitest](https://pitest.org) mutation testing**. See last commit of [pitest](https://github.com/jonathanlermitage/manon/tree/pitest) branch
...
* **Swagger UI** to provide documentation about REST API endpoints
  ...
  * **migration to OpenAPI 3 with Springdoc**. Check Swagger UI [`http://localhost:8080/swagger-ui.html`](http://localhost:8080/swagger-ui.html), JSON OpenAPI docs [`http://localhost:8080/v3/api-docs`](http://localhost:8080/v3/api-docs), YAML OpenAPI docs [`http://localhost:8080/v3/api-docs.yaml`](http://localhost:8080/v3/api-docs.yaml). See last commit of [springdoc-openapi-v3](https://github.com/jonathanlermitage/manon/tree/springdoc-openapi-v3) branch
