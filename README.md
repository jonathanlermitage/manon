...
* integration with **[OWASP dependency check plugin](https://maven.apache.org/enforcer/maven-enforcer-plugin/)**. See last commit of [spring5-light-owasp-dependency-check-plugin](https://github.com/jonathanlermitage/manon/tree/spring5-light-owasp-dependency-check-plugin) branch
