...
@Component
@Getter
@ToString(exclude = {"defaultUserActuatorPassword", "defaultUserAdminPassword", "securityJwtSigningKeyB64", "mailPassword"})
@Validated
public class Cfg {
    ...
    @Value("${manon.batch.notification-email-to}")
    private String batchNotificationEmailTo;
